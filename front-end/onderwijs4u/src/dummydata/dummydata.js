...
export const student_projects = ref({
    ...
    "Intro ICT beroepsproduct": {
        id: 1, running: true, description: 'beroepsproduct', criteriaToReach: {
    ...
    // },
    "OOPD Game": {
        id: 2, running: false, description: 'beroepsproduct', criteriaToReach: {
    ...
    "FAT Beroepsproduct": {
        id: 5, running: false, description: 'beroepsproduct', criteriaToReach: {
    ...
    "SPB Huiswerkopdrachten": {
        id: 6, running: false, description: 'beroepsproduct', criteriaToReach: {
    ...
    "WTUX Fletnix": {
        id: 7, running: false, description: 'beroepsproduct', criteriaToReach: {
                ...
                criteria: [
                    ...
                    },
                    {
                        id: 2, beoordelingscriteria: 'OOPD', fase: 'Uitvoerings', criteria: [
                            { id: 1, project: 'OOPD-1', verantwoording: '• I applied innovative solutions to solve problems.', },
                            { id: 2, project: 'OOPD-2', verantwoording: '• I ensured all tasks were completed on time.', },
                            { id: 3, project: 'OOPD-3', verantwoording: '• I reviewed all work thoroughly before submission.', },
                            { id: 4, project: 'OOPD-4', verantwoording: '• I faced challenges but overcame them with persistence.', },
                        ],
                    },
                    {
                        id: 3, beoordelingscriteria: 'EPD22', fase: 'Afronding', criteria: [
                            { id: 1, project: 'EPD-1', verantwoording: '• Leest sensoren op de juiste manier uit, waardoor de gelezen waarden op de juiste manier kunnen worden verwerkt in de software.', },
                            ...
                            { id: 6, project: 'EPD-8', verantwoording: '• Implementeert software-timers, dus zonder gebruik van de delay-functie of een equivalent daarvan, om meerdere taken schijnbaar gelijktijdig te laten uitvoeren.', },
                        ],
                    },
                    {
                    ...
                    },
                    {
                        id: 11, beoordelingscriteria: 'WTUX', fase: 'Afronding', criteria: [
                            { id: 1, project: 'WTUX-1', verantwoording: '• De specificatie is volledig verwerkt in de wireframes.', },
                ...
                criteria: [
                    {
                        id: 1, beoordelingscriteria: 'OSM-MO', fase: 'Ontwikkeling', criteria: [
                            ...
                            { id: 3, project: 'OSM-MO-3', verantwoording: '• Gebruikt en beschrijft op correcte wijze de UML syntax van een sequence-diagram (inclusief visualisatie).', },
                            { id: 4, project: 'OSM-MO-4', verantwoording: '• Gebruikt en beschrijft op correcte wijze de UML syntax van een activity- en state-diagram (inclusief visualisatie).', },
                            ...
                            { id: 7, project: 'OSM-MO-7', verantwoording: '• Gebruikt en beschrijft op correcte wijze de UML syntax van een deployment- en component- en package-diagram (inclusief visualisatie).', },
                            { id: 8, project: 'OSM-MO-8', verantwoording: '• Kan bedenken/identificeren wat een mogelijk onderdeel/component is van een systeem.', },
                            { id: 9, project: 'OSM-MO-9', verantwoording: '• Vertaalt de UML-syntax van de verschillende diagrammen naar C++-code met herkenbare OO-constructen.', },
                    ...
                    },
                    {
                        id: 2, beoordelingscriteria: 'OSM-SO', fase: 'Uitvoerings', criteria: [
                            { id: 1, project: 'OSM-SO-1', verantwoording: '• Installeert de GNU C++ compiler op een van de platforms Windows, Linux, Mac.\n• Installeert, configureert en gebruikt Eclipse. Het werk wordt ingeleverd als Eclipse-project', },
                            { id: 2, project: 'OSM-SO-2', verantwoording: '• Gebruikt SVN of Git en levert het materiaal in in de vorm van een repository-export.', },
                            { id: 3, project: 'OSM-SO-3', verantwoording: '• Gebruikt een van de unit-test frameworks Boost Test Library, CppUnit, Google Test.', },
                            ...
                            { id: 5, project: 'OSM-SO-6', verantwoording: '• Implementeert het ontwerp in C++ zoals vastgelegd in UML, conform de UML run-time semantiek.', },
                            ...
                            { id: 8, project: 'OSM-SO-10', verantwoording: '• Licht de testen mondeling toe en motiveert eventuele afwijkingen van de gestelde eisen.', },
                            ...
                            { id: 12, project: 'OSM-SO-16', verantwoording: '• Implementeert het ontwerp in C++ zoals vastgelegd in UML, conform de UML run-time semantiek.', },
                    ...
                    },
                    {
                        id: 4, beoordelingscriteria: 'IoT-S', fase: 'Voorbereiding', criteria: [
                            { id: 1, project: 'IoT-SW-1', verantwoording: '• Richt een werkende ontwikkelomgeving voor de benodigde programmeertalen en doelplatformen.', },
                            ...
                            { id: 7, project: 'IoT-SW-8', verantwoording: '• Legt de resultaten van een prototypetraject vast, houdt voortgangsverslag bij, overweegt alternatieven en legt deze vast, verantwoordt met argumenten, zowel schriftelijk als mondeling, de genomen keuzes.', },
                        ],
                    },
                    {
                        id: 5, beoordelingscriteria: 'IoT-TE', fase: 'Ontwikkeling', criteria: [
                            ...
                            { id: 2, project: 'IoT-TECH-2', verantwoording: '• Heeft kennis van het OSI-lagenmodel, de interfacing tussen lagen, de algemene pakketopbouw, de toevoeging van headers per laag, overhead, het verschil tussen directe en virtuele verbindingen.', },
                            ...
                            { id: 8, project: 'IoT-TECH-8', verantwoording: '• Geeft m.b.v. logic analyzer uitleg over gebruikte protocollen en onderlinge timing.', },
                            ...
                            { id: 11, project: 'IoT-TECH-11', verantwoording: '• Implementeert één of meer cryptografische algoritmen op embedded systemen en beoordeelt deze op snelheid en geheugengebruik.', },
                        ],
                    },
                    {
                ...
                criteria: [
                    {
                        id: 2, beoordelingscriteria: 'WoR-Rbts', fase: 'Uitvoerings', criteria: [
                            ...
                            { id: 2, project: 'WoR-R-2', verantwoording: '• Analyseert het gebruik van resources, het tijdaspect en de concurrency met de relevante elementen uit het UML real time resource modeling subprofile.', },
                            ...
                            { id: 6, project: 'WoR-R-8', verantwoording: '• Gebruikt relevante elementen uit tenminste de C++ standard libraries utility library, string library, container library en iterator library.', },
                            { id: 7, project: 'WoR-R-9', verantwoording: '• Gebruikt relevante elementen uit tenminste de C++ standard libraries utility library, atomaire operaties library en thread support library.', },
                            ...
                            { id: 10, project: 'WoR-R-14', verantwoording: '• Analyseert relevante aspecten van een embedded systeem met beschrijvende statistiek.', },
                            ...
                            { id: 12, project: 'WoR-R-16', verantwoording: '• Geeft argumenten voor een concrete casus voor ontwerpbeslissingen met betrekking tot synchrone en a-synchone communicatie, error detectie, fault tolerance en consensus.', },
                            { id: 13, project: 'WoR-R-17', verantwoording: '• Beoordeelt het ontwerp op tenminste de onderdelen compleetheid, consistentie, performance, timeliness, safety, reliability, security, quality, scalability, het gebruik van architectural patterns en het gebruik van design patterns.', },
                        ],
                    },
                    {
                        id: 3, beoordelingscriteria: 'WoR-Wrld', fase: 'Afronding', criteria: [
                            ...
                            { id: 6, project: 'WoR-W-7', verantwoording: '• Voorziet het gemaakte UML-ontwerp van toevoeging van relevante zaken uit de UML Real Time subprofielen voor Time, Schedulability en Performance.', },
                            ...
                            { id: 8, project: 'WoR-W-10', verantwoording: '• Neemt de verschillende UML notaties uit de RT-subprofielen uit het ontwerp op in de implementatie en kan deze aanwijzen in de code.', },
                            { id: 9, project: 'WoR-W-11', verantwoording: '• Laat zien dat de hardware kan worden uitgelezen en aangestuurd op basis van de afgesproken interface.', },
                            { id: 10, project: 'WoR-W-12', verantwoording: '• Beargumenteert inzetbaarheid van hardware in het gewenste systeem op basis van gevonden QoS-mogelijkheden. Hierbij worden voor het modelleren van resources onderkend: (1) het door de hardware (sub)systemen aangeboden QoS is minstens even goed als vereiste QoS; (2) resource beschikbaarheid.\n• Bepaalt de grenzen en onzekerheden van een systeem, rekening houdend met soft- en hard-realtime zaken.\n• Bepaalt met behulp van statistiek wat de eigenschappen van een systeem zijn en legt hiermee de timeliness eigenschappen van het systeem vast. Hierbij worden begrippen gehanteerd als histogram, verdeling, modus, deviatie.', },
                            { id: 11, project: 'WoR-W-13', verantwoording: '• Installeert, configureert en gebruikt een simulatieomgeving.', },
                            { id: 12, project: 'WoR-W-14', verantwoording: '• Laat zien dat de hardware kan worden uitgelezen en aangestuurd op basis van de afgesproken interface.', },
