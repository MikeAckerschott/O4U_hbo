...
const students = ref([
  ...
  { id: 19, name: 'Finn van den Berg', progress: 95, yearOfStudy: 3 },
  ...
  { id: 38, name: 'Gijs van der Veer', progress: 90, yearOfStudy: 3 },
  { id: 39, name: 'Mick van der Linden', progress: 75, yearOfStudy: 3 },
  { id: 40, name: 'Saar van der Linden', progress: 95, yearOfStudy: 3 },
])
