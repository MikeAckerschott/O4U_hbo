...
const student_project = ref({
  "WoR-project": {
    id: 1, running: false, description: 'Description of Project A', criteriaToReach: {
      "WoR-P-1": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-2": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-3": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-4": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-5": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-6": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-7": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-8": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-9": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
      "WoR-P-10": { studentVerantwoording: "Ik heb deze criteria behaald door..." },
    }
  },
  "otherProject": [
...
let projectInfo = Object.entries(student_project.value[project].criteriaToReach).map(([key, item]) => {
  return {
    id: key,
    name: key,
    active: true,
