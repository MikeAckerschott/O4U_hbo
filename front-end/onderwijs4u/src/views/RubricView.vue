...
const mappedData = ref({
  ...
  OOPD: [
    ...
    { id: 4, project: 'OOPD-4', verantwoording: 'I faced challenges but overcame them with persistence.', linked_project: 'Voorbereiding', feedback: 'Good effort, but more persistence needed.', beoordeling: 'Onvoldoende' },
  ],
  EPD22: [
  ...
  'OSM-SO': [
    ...
    { id: 6, project: 'OSM-SO-6', verantwoording: '• Implementeert het ontwerp in C++ zoals vastgelegd in UML, conform de UML run-time semantiek.', linked_project: 'Voorbereiding', feedback: 'Good effort, but more persistence needed.', beoordeling: 'Onvoldoende' },
    ...
    { id: 9, project: 'OSM-SO-10', verantwoording: '• Licht de testen mondeling toe en motiveert eventuele afwijkingen van de gestelde eisen.', linked_project: 'Afronding', feedback: 'Needs more understanding of key concepts.', beoordeling: 'Onvoldoende' },
    ...
    { id: 13, project: 'OSM-SO-16', verantwoording: '• Implementeert het ontwerp in C++ zoals vastgelegd in UML, conform de UML run-time semantiek.', linked_project: 'Afronding', feedback: 'temp', beoordeling: 'Goed' },
